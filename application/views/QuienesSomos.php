...
<div class="container">
    <img src="<?= base_url() . 'assets/' ?>imagenes/bannerabout.jpg" alt="Banner" id="bottombanner" href="Quienes Somos.php">
        ...
        <ul id="bottom-band-menu">
            ...
            <li>
                <div id="search_wrapper">
                    <?php echo form_open('welcome/QuienesSomos'); ?>
            ...
            <li>                <span><?php echo validation_errors(); ?></span>
            </li>
        </ul>
    </div>
    <div id="heading">
