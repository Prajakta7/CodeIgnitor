...
<div class="container">
    <img src="<?= base_url() . 'assets/' ?>imagenes/bannerregistro.jpg" alt="Banner" id="bottombanner" href="IncinarSesion.php">
...
<div id="myModal1" class="modal">
    ...
    <div class="modal-content">
        ...
        <form action="<?= base_url().'index.php/welcome/registrate' ?>" method="post" onsubmit="return ValidationEvent()">
